package com.aranea_apps.android.libs.commons.logging;
...
public class ALog {
  ...
  public static void d(String tag, final String... messages) {
    for (String s : messages)
      ALog.d(tag, s, null);
  }

  public static void d(final String... messages) {
    d(debugTag, messages);
  }
  ...
  public static void d(String tag, final Object... objects) {
